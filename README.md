...
| Semestre | Disciplina | Atividades / Projetos | Link do Repositório | Status |
|----------|------------|-----------------------|---------------------|--------|
| 2026.2   | Garantia da Qualidade de Software | [🔗 Ver Repositório](https://github.com/dev-Anthonym/GQS-Atividade1-DanielPaiva.git) | ✅ Concluído |
|
|
|
